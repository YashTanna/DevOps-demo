...
function Profile() {
  ...
  const fetchUserSkills = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/skills/all`, {
        method: "GET",
        headers: { Authorization: `Basic ${authToken}` },
      });
  ...
  const fetchUserExperiences = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/expr/all`, {
        method: "GET",
        headers: { Authorization: `Basic ${authToken}` },
      });
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/users/updateUser`, {
        method: "POST",
        headers: { Authorization: `Basic ${authToken}` },
        body: formDataToSend, 
      });
  ...
  const handleAddExperience = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/expr/create`, {
        method: "POST",
        headers: { Authorization: `Basic ${authToken}` },
        body: formDataToSend, 
      });
  ...
  const handleDeleteSkill = async (skillId) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/skills/delete/${skillId}`,
        {
          method: "DELETE",
          headers: { Authorization: `Basic ${authToken}` },
        }
  ...
  const handleDeleteExperience = async (experienceId) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/expr/delete/${experienceId}`,
        {
          method: "DELETE",
          headers: { Authorization: `Basic ${authToken}` },
        }
