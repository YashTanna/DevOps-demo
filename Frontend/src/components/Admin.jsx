...
const Admin = () => {
  ...
  const fetchAllUsers = async () => {
    const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/all-users`);
    if (response.ok) {
      const data = await response.json();
      setUsers(data);
  ...
  const fetchUserDetails = async (userName) => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/userProfile/${userName}`);
  ...
  const handleDeleteUser = async (userId, userName) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/user/delete/${userId}`, {
        method: 'DELETE',
      });
  ...
  const handleAddSkill = async () => {
    ...
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/skill/create`, {
        method: 'POST',
        body: formData
      });
  ...
  const handleDeleteSkill = async (skillName) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/skill/delete?skillName=${encodeURIComponent(skillName)}`, {
        method: 'DELETE',
      });
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      const deleteResponse = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/skill/delete?skillName=${encodeURIComponent(oldSkill)}`, {
        method: 'DELETE',
      });
      ...
      const addResponse = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/skill/create`, {
        method: 'POST',
        body: formData
      });
